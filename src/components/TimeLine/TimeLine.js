...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        During my time at Rochester Institute of Technology, I have completed a
        number of courses that have given me a solid foundation in software
        engineering principles. These courses have included:-
      </SectionText>
